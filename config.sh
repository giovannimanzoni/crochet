...
option ImageSize 1024mb # for 1 Gigabyte card, test
...
# 
# Set remote FreeBSD repo
#
# https://forums.freebsd.org/threads/current-vs-stable-vs-release.3716/
#
FREEBSD_REPO=https://svn.freebsd.org/base/release/10.2.0/
...
#
FREEBSD_SRC=${TOPDIR}/BBB/src10.2.0
...
#
IMG=${TOPDIR}/BBB/FreeBSD-${KERNCONF}.img
...
#Source Jobs for build cross-compiling tools. Must be set
SRCJOBS="-j 24"
